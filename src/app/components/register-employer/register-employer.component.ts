...
export class RegisterEmployerComponent implements OnInit {
  ...
  private buildForm(): void {
    this.employerForm = this.fb.group({
      ...
      countryCode: this.fb.control('+1', { validators: [Validators.required, Validators.pattern('^\\+[0-9]{1,4}$')] }),
      phoneNumber: this.fb.control('', { validators: [Validators.required, Validators.pattern('^[0-9]*$')] }),
